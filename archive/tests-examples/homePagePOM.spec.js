...
// Validate total 46 links on the home page   
// Validate expected link text on the home page 
...
test.describe('Home Page validation', () => {
  ...
  test('Validate total 46 links on the home page  ', async ({ page }) => {
    //await page.goto('https://the-internet.herokuapp.com/');
  ...
  test('Validate expected link text on the home page ', async ({ page }) => {
    //await page.goto('https://the-internet.herokuapp.com/');
    ...
    // Validate expected link text on the home page 
    await expect.soft(page.locator('li:nth-of-type(1) a')).toHaveText('A/B Testing');
    await expect.soft(page.locator('li:nth-of-type(2) a')).toHaveText('Add/Remove Elements');
    await expect.soft(page.locator('li:nth-of-type(3) a')).toHaveText('Basic Auth');
    await expect.soft(page.locator('li:nth-of-type(4) a')).toHaveText('Broken Images');
    await expect.soft(page.locator('li:nth-of-type(5) a')).toHaveText('Challenging DOM');
